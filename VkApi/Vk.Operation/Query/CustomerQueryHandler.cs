    ...
    IRequestHandler<GetCustomerById, ApiResponse<CustomerResponse>>
{
    ...
    {
        List<Customer> x =  await unitOfWork.CustomerRepository.GetAll(cancellationToken, "Orders");
    ...
    {
        Customer x = await unitOfWork.CustomerRepository.GetById(request.Id, cancellationToken , "Orders");
